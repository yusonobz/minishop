            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form  method="post" action="{{ route('reservation.destroy',$reservation->id) }}" class="delete_form">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                                <a href="{{ route('reservation.edit',$reservation->id) }}" class="btn btn-xs btn-primary">Edit</a>
